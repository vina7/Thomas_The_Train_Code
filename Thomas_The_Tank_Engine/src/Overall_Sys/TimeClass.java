...
/**
 * This class is a singleton so the data can be used across modules. This is used the time across the system
...
public class TimeClass {
	...
	/**
	 * Returns whether the time has changed since the last track controller module call
	 * @return changed
	 */
	...
	/**
	 * Used to tell if the track controller module has already called the getChangedTrackTime method before
	 */
	...
	/**
	 * Used to tell if the train module has already called the getChangedTrainTime method before
	 */
