...
public class BrokenTracks {
	 ...
	 /**
	  * Constructor 
	  * @param Line Track's line
	  * @param BlockNum Track's block number
	  * @param TimeToFixRail Time to fix the rail
	  * @param Closed If the block is closed or not
	  * @param ClosedTime The time the block was closed
