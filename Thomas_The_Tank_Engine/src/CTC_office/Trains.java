...
public class Trains {
	...
	public Trains(Color color, int ID, int Speed, int Authority, String Direction, String PrevSection, String Section,
			int BlockNum, int BlockLen, double BlockGrade, int BlockSpeedLim, double Elevation, boolean Retire,
			String Status, String Station, int DestBlock, List<ScheduleInfo> TrainSchedule, boolean UserSetSpeed,
			boolean UserSetDest, int DisplaySpeed, int StationNum) {
		this.color = color;
		this.ID = ID;
		this.Status = Status;
		this.Speed = Speed;
