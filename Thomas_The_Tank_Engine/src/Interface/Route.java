...
public class Route {
	...
	public String getNextRed(String prev, String curr) {
		...
		for (int i = 0; i < redRoute.size(); i++) {
			if ((((redRoute.get(i)).getPrev()).equalsIgnoreCase(prev))
					&& (((redRoute.get(i)).getCurr()).equalsIgnoreCase(curr))) {
	...
	public String getNextGreen(String prev, String curr) {
		...
		for (int i = 0; i < greenRoute.size(); i++) {
			if ((((greenRoute.get(i)).getPrev()).equalsIgnoreCase(prev))
					&& (((greenRoute.get(i)).getCurr()).equalsIgnoreCase(curr))) {
