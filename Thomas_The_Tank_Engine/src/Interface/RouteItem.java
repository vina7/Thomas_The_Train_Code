...
public class RouteItem {
	/**
	 * 
	 * @author Kaitlyn Carey This file is was part of the system prototype. It
	 *         is used as a place holder for the track controller. So it is not
	 *         commented
	 */
	...
	boolean reverse; // false if traversing blocks in ascending order, true if
						// traversing blocks in descending order

	/* Block Constructor */
	public RouteItem(String initPrev, String initCurr, String initNext, int initEntryBlockNum, int initExitBlockNum,
			boolean initReverse) {
		prev = initPrev;
		curr = initCurr;
		next = initNext;
