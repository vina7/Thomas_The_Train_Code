...
/**
 * This class is a singleton so the data can be used across modules. Used as the
 * interface between the CTC and Track Controller for which blocks are broken
 * and closed.
 * 
...
public class ClosedRails {
	...
	/**
	 * Updates the Block object stored in the class. Then add sets certain
	 * broken blocks to closed
	 * 
	 * @param Blocks
	 *            Stores all of the system's block information
	 * @param Line
	 *            Tells which line the closed block is in
	 */
